...
class BioPar:
    ...
    # ── loss parameters (all) ──
    m_l: float = 0.02 / 86400 * loss_multiplier # Linear loss (1/s) 
    m_q: float = 0.10 / 86400 * loss_multiplier# Quadratic loss (1 / uM C s)
    bmin: float = 1e-10  * loss_multiplier      # Minimum biomass
